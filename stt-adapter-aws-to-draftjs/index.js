...
const { groupWordsBySpeaker } = require('./group-words-by-speakers.js');


const stripLeadingSpace = word => {
...
const appendPunctuationToPreviousWord = (punctuation, previousWord) => {
...
const mapPunctuationItemsToWords = words => {
  const itemsToRemove = [];
...
module.exports.stripLeadingSpace  = stripLeadingSpace;